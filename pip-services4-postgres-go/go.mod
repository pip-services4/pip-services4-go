module github.com/pip-services4/pip-services4-go/pip-services4-postgres-go
...
require (
	...
	github.com/pip-services4/pip-services4-go/pip-services4-persistence-go v0.0.2-4
