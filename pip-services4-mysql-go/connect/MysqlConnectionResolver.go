...
func (c *MySqlConnectionResolver) validateConnection(traceId string, connection *cconn.ConnectionParams) error {
	uri := connection.Uri()
	if uri != "" {
		return nil
	}
...
func (c *MySqlConnectionResolver) validateConnections(traceId string, connections []*cconn.ConnectionParams) error {
...
func (c *MySqlConnectionResolver) Resolve(ctx context.Context) (uri string, err error) {
