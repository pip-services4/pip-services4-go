...
import (
	...
	azuresrv "github.com/pip-services4/pip-services4-go/pip-services4-azure-go/controllers"
...
type DummyAzureFunctionController struct {
	*azuresrv.AzureFunctionController

	service tlogic.IDummyService
}

func NewDummyAzureFunctionController() *DummyAzureFunctionController {
	c := DummyAzureFunctionController{}

	c.AzureFunctionController = azuresrv.InheritAzureFunctionController(&c, "dummies")
	c.DependencyResolver.Put(context.Background(), "service", crefer.NewDescriptor("pip-services-dummies", "service", "default", "*", "*"))

	return &c
}

func (c *DummyAzureFunctionController) SetReferences(ctx context.Context, references crefer.IReferences) {
...
func (c *DummyAzureFunctionController) getPageByFilter(res http.ResponseWriter, req *http.Request) {
...
func (c *DummyAzureFunctionController) getOneById(res http.ResponseWriter, req *http.Request) {
...
func (c *DummyAzureFunctionController) create(res http.ResponseWriter, req *http.Request) {
	traceId := c.GetTraceId(req)
...
func (c *DummyAzureFunctionController) update(res http.ResponseWriter, req *http.Request) {
	traceId := c.GetTraceId(req)
...
func (c *DummyAzureFunctionController) deleteById(res http.ResponseWriter, req *http.Request) {
	traceId := c.GetTraceId(req)
...
func (c *DummyAzureFunctionController) getDummy(req *http.Request) (tdata.Dummy, error) {
...
func (c *DummyAzureFunctionController) Register() {
