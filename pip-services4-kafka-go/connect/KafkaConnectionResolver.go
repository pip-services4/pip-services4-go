...
func (c *KafkaConnectionResolver) validateConnection(traceId string, connection *ccon.ConnectionParams) error {
	if connection == nil {
		return cerr.NewConfigError(traceId, "NO_CONNECTION", "Kafka connection is not set")
	}
...
func (c *KafkaConnectionResolver) Resolve(ctx context.Context) (*cconf.ConfigParams, error) {
