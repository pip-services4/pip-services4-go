...
// Returns trace_id from request struct
// Parameters:
//   - req	request struct
//
// Returns trace id string or empty
func (c *_TCloudFunctionRequestHelper) GetTraceId(req *http.Request) string {
...
//
// Returns Parameters
func (c *_TCloudFunctionRequestHelper) GetParameters(req *http.Request) *cexec.Parameters {
